          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildOptionTile(
                context: context,
                index: 0,
                text: 'I only get breathless with strenuous exercise(Grade 0)',
              ),
              _buildOptionTile(
                context: context,
                index: 1,
                text: 'I get short of breath when hurrying on the level or walking up a slight hill(Grade 1)',
              ),
              _buildOptionTile(
                context: context,
                index: 2,
                text: 'I walk slower than people of the same age on the level because of breathlessness or have to stop for breath when walking at my own pace on the level(Grade 2)',
              ),
              _buildOptionTile(
                context: context,
                index: 3,
                text: 'I stop for breath after walking about 100 yards or after a few minutes on the level(Grade 3)',
              ),
              _buildOptionTile(
                context: context,
                index: 4,
                text: '"I am too breathless to leave the house" or "I am breathless when dressing"(Grade 4)',
              ),
            ],
          ),
        ),
