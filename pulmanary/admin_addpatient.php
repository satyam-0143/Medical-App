...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $cause = $_POST['cause'] ?? '';
    $age = $_POST['P_age'] ?? null; // Change to null if not provided
    ...
    // Prepare to handle NULL values for age
    $ageValue = ($age === null || $age === '') ? 'NULL' : "'$age'";

    // Insert data into the patient_info table
    $sql2 = "INSERT INTO patient_info (P_id, P_name, P_gender, cause, P_age) 
             VALUES ('$username', '$name', '$gender', '$cause', $ageValue)";
